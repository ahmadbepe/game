...
Partial Public Class MyDBDataSet
    ...
    Partial Public Class mahasiswaDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddmahasiswaRow(ByVal nim As Integer, ByVal Nama As String) As mahasiswaRow
            Dim rowmahasiswaRow As mahasiswaRow = CType(Me.NewRow,mahasiswaRow)
            Dim columnValuesArray() As Object = New Object() {nim, Nama}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Sub InitClass()
            Me.columnnim = New Global.System.Data.DataColumn("nim", GetType(Integer), Nothing, Global.System.Data.MappingType.Element)
    ...
    Partial Public Class mahasiswaRow
        ...
        Public Property nim() As Integer
            Get
                Try 
                    Return CType(Me(Me.tablemahasiswa.nimColumn),Integer)
...
Namespace MyDBDataSetTableAdapters
    ...
    Partial Public Class mahasiswaTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `mahasiswa` (`nim`, `Nama`) VALUES (?, ?)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("nim", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "nim", Global.System.Data.DataRowVersion.Current, false, Nothing))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.GameVB.My.MySettings.Default.MyDatabase
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT nim, Nama FROM mahasiswa"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As MyDBDataSet.mahasiswaDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As MyDBDataSet.mahasiswaDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As MyDBDataSet.mahasiswaDataTable = New MyDBDataSet.mahasiswaDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As MyDBDataSet.mahasiswaDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal nim As Global.System.Nullable(Of Integer), ByVal Nama As String) As Integer
            If (nim.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(0).Value = CType(nim.Value,Integer)
            Else
